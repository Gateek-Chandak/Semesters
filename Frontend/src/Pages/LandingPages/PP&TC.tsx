        ...
        <div className="lg:bg-[#f1f0f0] w-full h-dvh">
            ...
            <div className="flex flex-col items-start justify-start h-dvh overflow-auto pt-24 px-10">
                <div className="mb-16 flex flex-col gap-10">
                    ...
                    When you upload a syllabus or transcript to Semesters, we temporarily process the document to extract relevant data, such as course schedules, deadlines, and academic records.  If you choose to create a schedule 
                    based on your uploaded syllabus or transcript, we store the schedule data to provide the functionality of exporting to Google Calendar or managing your calendar events within the application.
                    {/* </p>
                    <p className="mx-10"> */}
                    Semesters allows you to export schedules and events to your Google Calendar. This requires access to your Google account, granted via third-party authentication. We do not store your Google account credentials.
                ...
                <div className="mb-16 mt-16 flex flex-col gap-10">
                    ...
                    <p className="mx-10">
                        ...
                        These Terms and Conditions are governed by and construed in accordance with the laws of [Your Jurisdiction]. Any disputes arising under these terms will be subject to the exclusive jurisdiction of the courts in [Your Jurisdiction].
                    </p>
